...
def test_doc2md_full_pipeline():
    ...
    from doc2md import convert_document, extract_doc_metadata
...
def test_pdf2md_text_path():
    ...
    from pdf2md import extract_pages, pages_to_markdown, extract_pdf_metadata
    import fitz
...
def test_img2md_full_pipeline():
    ...
    from img2md import load_vlm_model, image_to_markdown_text, image_to_markdown, get_image_metadata
...
def test_pdf2md_ocr_path():
    ...
    from pdf2md import load_vlm_for_pdf, extract_page_via_vlm
    from pathlib import Path
...
def test_yt2md_transcription():
    ...
    audio = Path(__file__).parent / "test_audio" / "test_voice.mp3"
    if not audio.exists():
